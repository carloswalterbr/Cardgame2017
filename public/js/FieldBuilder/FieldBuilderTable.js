FieldBuilder.prototype._calcGenTableSizes = function(numOfTables){
	...
	var halfRows = Math.floor(game.scale.numRows / 2),
		tableCells = this._tableCells = this._opponentPlacement[0] ? Math.round(game.scale.numCols - 8 - game.scale.density* 1.5) : game.scale.numCols - 2,
	...
	this.positions.table = game.scale.cellAt(
		this._opponentPlacement[0] ? 3 + game.scale.density : 1,
		halfRows - 1,
		-this.offsets.table,
		-this.offsets.table,
		'middle left'
